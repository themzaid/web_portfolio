import React, { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, Component, ReactNode } from 'react';
...
class CanvasErrorBoundary extends Component<{ children: ReactNode }, { hasError: boolean }> {
  ...
  render() {
    if (this.state.hasError) {
      // If WebGL crashes (common on some Android devices), fail gracefully instead of white-screening the DOM
      return <div className="beams-container bg-black" />;
    }
...
const DirLight = ({ position, color }: any) => {
  ...
  // Moved the light MUCH further back [0, 15, 40] and increased intensity to 3
  // This spreads the specular highlight perfectly across the whole screen!
  return <directionalLight ref={dir} color={color} intensity={3} position={[0, 15, 40]} />;
};
